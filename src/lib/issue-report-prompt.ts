...
const PREAMBLES: Record<ReportCategory, string[]> = {
  bug: [
    "The user is filing a bug report about the Sub Rosa desktop app. This conversation is part of the in-app reporting flow: your reply will be attached to the report draft before it is sent to the Sub Rosa development team, so write it for them.",
    "",
    ...
    "",
    "Keep it concise and factual. Close by thanking the user and letting them know they can add more context before sending it to the Sub Rosa team.",
  ],
  feedback: [
    "The user is sharing feedback about the Sub Rosa desktop app. This conversation is part of the in-app feedback flow: your reply will be attached to the feedback draft before it is sent to the Sub Rosa development team, so write it for them.",
    "",
    ...
    "",
    "Keep it concise and warm. Close by thanking the user and letting them know they can add more context before sending it to the Sub Rosa team.",
  ],
  feature: [
    "The user is requesting a feature for the Sub Rosa desktop app. This conversation is part of the in-app request flow: your reply will be attached to the request draft before it is sent to the Sub Rosa development team, so write it for them.",
    "",
    ...
    "",
    "Keep it concise and constructive. Close by thanking the user and letting them know they can add more context before sending it to the Sub Rosa team.",
  ],
};
