...
import { ROSE_MARK_PATH, ROSE_MARK_VIEWBOX } from "../brand/roseMark";
  ...
  return (
    <div className="welcome-screen">
      <div className="welcome-card">
        ...
        <h1 className="welcome-title">Sub Rosa could not finish starting</h1>
...
// The Sub Rosa rose glyph. (Component names kept as JuneMark* — technical
// identifiers imported in several places — while the rendered brand is the
// Sub Rosa rose.)
function JuneMarkPaths({ fill }: { fill?: string }) {
  return <path fill={fill} d={ROSE_MARK_PATH} />;
}
