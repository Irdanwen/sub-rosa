    ...
    <div className="settings-page">
      <header className="settings-header">
        ...
        <p className="settings-description">
          {account.localDev
            ? "Local mode is active. Sub Rosa uses your local backend without OpenSoftware sign-in or billing."
          ...
          <div className="settings-row">
            <div className="settings-row-info">
              ...
              <p className="settings-row-description">
                {account.localDev
                  ? "Requests use your local backend. No OpenSoftware account is used."
                  : account.signedIn
