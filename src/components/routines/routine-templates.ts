...
export const ROUTINE_TEMPLATES: RoutineTemplate[] = [
  {
    id: "morning-brief",
    name: "Morning brief",
    description: t("Open loops from recent sessions, your todos, and anything new that matters."),
    prompt: t(
  ...
  },
  {
    id: "weekly-review",
    name: "Weekly review",
    description: t("A Friday afternoon summary of the week's work and what to carry forward."),
    prompt: t(
  ...
  },
  {
    id: "news-watch",
    name: "News watch",
    description: t("Track a topic and only hear about it when something actually happens."),
    prompt: t(
  ...
  },
  {
    ...
    name: "Memory tidy",
    description: t(
      "A weekly pass over Sub Rosa's memory to merge duplicates and drop stale facts.",
    ),
    prompt: t(
  ...
  },
  {
    id: "downloads-tidy",
    name: "Tidy downloads",
    description: t("Sort the Downloads folder into subfolders by type every Friday."),
    prompt: t(
